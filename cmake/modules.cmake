option(RUNTIME_MODULE_DEFAULT_BUILTIN "Build runtime modules as builtin (OBJECT) by default" YES)
option(DRIVER_MODULE_DEFAULT_BUILTIN "Build driver modules as builtin (OBJECT) by default" NO)

macro(add_runtime_module)
    if(${RUNTIME_MODULE_DEFAULT_BUILTIN})
...
macro(add_driver_module)
    if(${DRIVER_MODULE_DEFAULT_BUILTIN})
