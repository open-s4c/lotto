...
(define _topic
	(_enum '(TOPIC_NONE = 0
		TOPIC_ENGINE_START = 1
		TOPIC_REPLAY_END = 2
		TOPIC_BEFORE_CAPTURE = 3
		TOPIC_BEFORE_MARSHAL_CONFIG = 4
		TOPIC_BEFORE_MARSHAL_FINAL = 5
		TOPIC_BEFORE_MARSHAL_PERSISTENT = 6
		TOPIC_AFTER_UNMARSHAL_CONFIG = 7
		TOPIC_AFTER_UNMARSHAL_FINAL = 8
		TOPIC_AFTER_UNMARSHAL_PERSISTENT = 9
		TOPIC_INFO_RECORD_LOAD = 10
		TOPIC_INFO_RECORD_SAVE = 11
		TOPIC_DELAYED_PATH = 12
		TOPIC_DEADLOCK_DETECTED = 13
		TOPIC_ENFORCE_VIOLATED = 14
		TOPIC_NEXT_TASK = 15
		TOPIC_TRIGGER_TIMEOUT = 16
		TOPIC_MEMMGR_RUNTIME_INIT = 17
		TOPIC_MEMMGR_USER_INIT = 18
		TOPIC_END_ = 19
)))
...
(define _topic-domain
	'(TOPIC_NONE
		TOPIC_ENGINE_START
		TOPIC_REPLAY_END
		TOPIC_BEFORE_CAPTURE
		TOPIC_BEFORE_MARSHAL_CONFIG
		TOPIC_BEFORE_MARSHAL_FINAL
		TOPIC_BEFORE_MARSHAL_PERSISTENT
		TOPIC_AFTER_UNMARSHAL_CONFIG
		TOPIC_AFTER_UNMARSHAL_FINAL
		TOPIC_AFTER_UNMARSHAL_PERSISTENT
		TOPIC_INFO_RECORD_LOAD
		TOPIC_INFO_RECORD_SAVE
		TOPIC_DELAYED_PATH
		TOPIC_DEADLOCK_DETECTED
		TOPIC_ENFORCE_VIOLATED
		TOPIC_NEXT_TASK
		TOPIC_TRIGGER_TIMEOUT
		TOPIC_MEMMGR_RUNTIME_INIT
		TOPIC_MEMMGR_USER_INIT
		TOPIC_END_
))
