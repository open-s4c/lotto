...
#define UDF_AARCH64_INSTR_EXIT_FAIL_VAL 0x0000aaab
#define UDF_AARCH64_INSTR_EXIT_FAIL                                            \
    AARCH64_INSTR0(UDF_AARCH64_INSTR_EXIT_FAIL_VAL)

#define UDF_AARCH64_INSTR_EXIT_STOP_VAL 0x0000aaac
#define UDF_AARCH64_INSTR_EXIT_STOP                                            \
    AARCH64_INSTR0(UDF_AARCH64_INSTR_EXIT_STOP_VAL)
