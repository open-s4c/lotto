...
bool
plan_has(struct plan p, enum action a)
{
...
const char *_action_to_str[] = {
    ...
    [ACTION_BLOCK] = "BLOCK",       [ACTION_RETURN] = "RETURN",
    [ACTION_YIELD] = "YIELD",       [ACTION_RESUME] = "RESUME",
    [ACTION_CONTINUE] = "CONTINUE", [ACTION_SNAPSHOT] = "SNAPSHOT",
    [ACTION_SHUTDOWN] = "SHUTDOWN",
};

const char *
action_str(enum action a)
{
