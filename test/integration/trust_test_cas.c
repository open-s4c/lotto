...
// RUN: (! %lotto %stress --handler-trust enable -r 10000 -- %b 2>&1) | filecheck %s
// CHECK: Total number of execution graphs: 390
// clang-format on
#include <assert.h>
#include <pthread.h>
#include <stdatomic.h>
